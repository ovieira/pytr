...
def export_transactions(input_path, output_path, lang="auto", csv_format=None):
    """
    ...
    if csv_format == "yahoo":
        # Use the Yahoo-specific CSV format
        from .yahoo_csv_format import export_yahoo_csv
        export_yahoo_csv(timeline, output_path, lang=lang)
    else:
        # Original logic for exporting transactions in the default format
